...
{
    "distutils": {
        "name": "dadapy._cython.__init__",
        "sources": [
            "/home/francesco/Desktop/dssc/robavaria/my_dadapy/DADApy/dadapy/_cython/__init__.py"
        ]
    },
    "module_name": "dadapy._cython.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__dadapy___cython
#define __PYX_HAVE_API__dadapy___cython
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "dadapy._cython" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "dadapy._cython.__init__"
extern int __pyx_module_is_main_dadapy___cython____init__;
int __pyx_module_is_main_dadapy___cython____init__ = 0;

/* Implementation of "dadapy._cython" */
...
static const char __pyx_k_dadapy__cython___init[] = "dadapy._cython.__init__";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_dadapy__cython___init __pyx_string_tab[2]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit__cython(); }
#endif
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "_cython" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit__cython", 0);
  ...
  if (__pyx_module_is_main_dadapy___cython____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_dadapy__cython___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dadapy._cython")) {
      if (unlikely((PyDict_SetItemString(modules, "dadapy._cython", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init dadapy._cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init dadapy._cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_dadapy__cython___init, sizeof(__pyx_k_dadapy__cython___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_dadapy__cython___init */
