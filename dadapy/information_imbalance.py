...
"""
The *information_imbalance* module contains the *InformationImbalance* class.

Algorithms for comparing different spaces via the information imbalance are implemented
...
class InformationImbalance(Base):
    """Class for information-imbalance-based comparisons between metric spaces."""
    ...
    def return_information_imbalace(
        ...
        for i, idx in enumerate(subsets):
            ...
            dist_indices_base, _ = _get_nn_indices(
                x_base,
                None,
                None,
                subset_size - 1,
            ...
            dist_indices_other, _ = _get_nn_indices(
                x_other,
                None,
                None,
                subset_size - 1,
    ...
    def return_inf_imb_causality_conditioning(
        ...
        d = InformationImbalance(maxk=cause_present.shape[0] - 1, n_jobs=self.n_jobs)
