...
class IdEstimation(Base):
	...
	def fix_Rk(self,Rk=None,ratio=None):
		...
		if ratio is not None:
			...
			assert self.r is not None, 'set self.r or insert a valure for the ratio parameter'

		if Rk is not None:
			self.set_Rk(Rk)
		else:
			assert self.Rk is not None, 'set self.R or insert a valure for the Rk parameter'
	...
	def fix_k(self,k_eff=None,ratio=None):
		...
		if ratio is not None:
			...
			assert self.r is not None, 'set self.r or insert a value for the parameter ratio'
	...
	def CramerRao(self,d=None,k=None,r=None,N=None):
		...
		if d is None:
			assert self.id_estimated_binom is not None, 'You have to compute the id using the binomial estimator first!'
