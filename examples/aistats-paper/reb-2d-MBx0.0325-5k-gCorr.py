...
savestring="2d-MBx0.0325-5k-simple_align-5reps"
noalign=False

# import dataset
X_full = np.genfromtxt('datasets/2d-MuellerBrown_times_0.0325-1M.dat')[::40, :2]

d = 2

F_full = -np.log(np.genfromtxt('datasets/2d-MuellerBrown_times_0.0325-1M.dat')[::40, 2])
