...
F_full = np.genfromtxt('datasets/9d-CLN025-F_anal-X_resampled-20k')
...
for i in reversed(range(0, nexp)):
    ...
    for r in range(nreps):
        ...
        results = run_all_methods(X_k, F_anal_k, d=d, noalign=noalign, maxk = min(X_k.shape[0] - 1, 90),period=2*np.pi)
