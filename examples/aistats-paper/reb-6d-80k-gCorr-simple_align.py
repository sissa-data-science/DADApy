...
for i in reversed(range(0, nexp)):
    ...
    for r in range(nreps):
        ...
        results = run_all_methods(X_k, F_anal_k, d=d, simple_align=True)
        ...
        #np.savez("results/reb-6d-80k-gCorr-k10-simple_align.npz",
        #np.savez("results/reb-6d-80k-gCorr-k10.npz",
        np.savez("results/reb-6d-80k-gCorr-kstar-simple_align.npz",
        #np.savez("results/reb-6d-80k-gCorr-kstar.npz",
            Nsample=Nsample,
            ksel_Abr=ksel_Abr,
            ksel_Zhao=ksel_Zhao,
            h_Sil=h_Sil,
