...
nexp = 6 # number of dataset sizes
...
for i in reversed(range(0, nexp)):
    ...
    for r in range(nreps):
        ...
        results = run_all_methods(X_k, F_anal_k, d=d, noalign=True, maxk = min(X_k.shape[0] - 1, 500))
        ...
        np.savez("results/2d-Gaussian-1-0.2-0.4-10k-gCorr-kstar-simple_align.npz",
            Nsample=Nsample,
            ksel_Abr=ksel_Abr,
            ksel_Zhao=ksel_Zhao,
            h_Sil=h_Sil,
