...
flake8: ## check style with flake8
	flake8 dadapy/_base.py dadapy/metric_comparisons.py dadapy/clustering.py dadapy/id_estimation.py dadapy/density_estimation.py tests #dev_scripts examples
